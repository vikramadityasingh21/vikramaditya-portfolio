      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className="group card-hover glass rounded-2xl p-6 fade-in-up"
        ...
        <div className="text-center mt-12 fade-in-up delay-400">
          <a href="#contact" className="inline-flex items-center space-x-2 text-purple-600 hover:text-purple-700 font-medium transition-colors">
