        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 fade-in-up">
            ...
            <div className="flex flex-col items-start">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-900 leading-tight tracking-tight mb-4" style={{ fontFamily: "'Cinzel', serif" }}>
                VIKRAMADITYA<br />
                <span className="gradient-text">SINGH</span>
              </h1>
              <div className="text-2xl md:text-3xl text-slate-700 font-semibold mb-3">
